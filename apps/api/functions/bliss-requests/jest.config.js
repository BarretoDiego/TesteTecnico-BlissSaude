/**
 * Testes do microserviço `bliss-requests`.
 *
...
module.exports = {
	...
	// o `where` opcional do Drizzle, o `.returning()` vazio, a contagem sem linha —
	// são cobertos por duplo injetado no construtor do repositório, que é a razão
	// de `dbPromise` existir.
	coverageThreshold: {
